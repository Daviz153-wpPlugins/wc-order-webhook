...
```bash
# Docker 실행
cd /Users/daviz/Projects/wordpress-dev
docker compose up -d

# 플러그인 디렉터리 (볼륨 마운트됨)
/Users/daviz/Projects/Wp-Plugin/wc-order-webhook/

# WordPress 관리자
http://localhost:8080/wp-admin
ID: gpartner153@gmail.com

# GitHub 저장소 클론 (로컬 비어있을 때)
cd /Users/daviz/Projects/Wp-Plugin/wc-order-webhook
